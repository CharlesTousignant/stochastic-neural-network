...
# ** my modifications
add_files -fileset [get_filesets sources_1] -norecurse $source_dir/hdl/utilsAxiWrapper.vhd
add_files -fileset [get_filesets sources_1] -norecurse $source_dir/hdl/neuralNetWrapper.vhd
# **

add_files -fileset [get_filesets sources_1] -force -norecurse $verilog_sources
set_property top neural_network_top [current_fileset]

# Generate Package
ipx::package_project -root_dir $source_dir/hdl -vendor user.org -library user -taxonomy /UserIP
